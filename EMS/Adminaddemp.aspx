                   ...
                   <tr>
                    ...
                    <tr>
                       ...
                       <asp:Label ID="Label7" runat="server" Text="Department-ID"></asp:Label>:</td><td>
                           <asp:DropDownList ID="deptid" runat="server" CssClass="tbox" value="" Width="180px"></asp:DropDownList><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate ="deptid" CssClass="val" ErrorMessage="Department-ID required"></asp:RequiredFieldValidator>
                          </td>
                    ...
                    <tr>
                       ...
                       <asp:Label ID="Label8" runat="server" Text="Job-ID"></asp:Label>:</td><td>
                            <asp:DropDownList ID="jid" runat="server" CssClass="tbox" placeholder="Select Job ID" Width="180px"></asp:DropDownList> <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate ="jid" CssClass="val" ErrorMessage="Job-ID required"></asp:RequiredFieldValidator>
                          </td>
                   </tr>
                   <tr>
                       <td>
                       <asp:Label ID="Label9" runat="server" Text="Gender"></asp:Label>:</td><td>
